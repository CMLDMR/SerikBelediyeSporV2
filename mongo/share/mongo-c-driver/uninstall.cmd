...
REM Mongo C Driver uninstall program, generated on €ar 10.10.2018 11:52:01,85
...
cd ..
echo Removing top-level installation directory: C:\mongor3.3.1\mongoc\
(rmdir C:\mongor3.3.1\mongoc\ 2>NUL) || echo ... not removed (probably not empty)
